        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center">
            <button 
              ...
              className="bg-white text-purple-700 px-3 sm:px-4 py-1 sm:py-2 rounded text-sm sm:text-base hover:bg-gray-100 transition-colors duration-200 whitespace-nowrap"
            >
              Logout
            </button>
          </div>
